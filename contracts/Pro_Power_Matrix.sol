        ...
        if (
            ...
            if (downlines[packageIndex][UplineOfStructure2].length < 4) {
                ...
                if (secondaryLine == 16) {
                    ...
                    usdtToken.transfer(address(this), remainingAmount / 2);
                } else if (secondaryLine <= 3) {
                    usdtToken.transfer(RoyaltyContract, remainingAmount / 2);
            ...
            if (downlines[packageIndex][UplineOfStructure2].length < 4) {
                ...
                for (
                    ...
                    if (
                        ...
                        // Recursively process the new structureUpline2
                        if (
                            secondLayerDownlines[packageIndex][
                                UplineOfStructure2
                            ].length == 16
